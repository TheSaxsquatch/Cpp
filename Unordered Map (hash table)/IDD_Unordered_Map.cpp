...
int main(){
    ...
    // Create hash table
    unordered_map<int, string> areaCodeMap {
    ...
    cout << "What area code would you like to search? \n";
    cin >> key;
    
    // Check for value in hash table 
    if (areaCodeMap.find(key)==areaCodeMap.end()){
        cout << "Apologies, area code does not exist in database. \n\n";
        cout << "What is the expected country for the area code? \n";

        cin >> country;

        cout << "Inserting the information into the data base now. \n\n";
        
        areaCodeMap[key]=country;
    }
